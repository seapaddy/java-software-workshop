...
/**
 * Sigs2WordsMap is a command-line program that prints possible words matching
...
public class Sigs2WordsMap {
	...
	/**
	 * Main method creates a map dictionary object. Using the dictionary object,
	...
	public static void main(String[] args) {
		MapDictionary dictionary = new MapDictionary(pathToDictionary);
